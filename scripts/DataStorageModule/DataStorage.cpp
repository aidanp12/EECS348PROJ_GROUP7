...
/* NOTE: This is an implementable version of the data storage module. The main function demonstrates
* how each method of the classes should be used. It could do for some finishing touches but I figured 
* it is far functional enough as is to consider it "finished". 
(09.12.24)
*/
